...
const timelineData = {
  human: [
    ...
    { year: "2075", event: "Début de la grande pandémie de <a href=\"#\" data-article=\"terran-pandemic\" class=\"text-blue-400 hover:text-blue-300\">Flutterite</a> sur Terre, seuls les sujets sains sont aptes à la migration vers Mars" },
  ...
  strani: [
    ...
    { year: "2412", event: "Première course officielle de <a href=\"#\" data-article=\"stardash-setting\" class=\"text-blue-400 hover:text-blue-300\">Stardash</a>"},
