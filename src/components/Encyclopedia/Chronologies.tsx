...
const timelineData = {
  ...
  {event: "Cette chronologie relate tous les événements majeurs de l’Histoire Vada depuis le début du 24eme siècle (les dates ont été converties en anciennes mesures terriennes pour faciliter la lecture)."},
    ...
    { year: "2365", event: "Afin d’éviter un massacre, le Grand Tribunal d’Arbitrage est créer, il deviens une institution gérer par les Gromula qui auront donc la charge d’arbitrer les conflits entre états."},
    ...
    { year: "2399", event: "Le projet \"Au-delà\" provoque une forte scission dans les différentes sociétés."},
