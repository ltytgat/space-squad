  ...
  fields: [
    ...
    // ── Arsenal ───────────────────────────────────────
    {
      ...
      fields: [
        ...
        {
          name: 'consommablesEquipes',
          type: 'relationship',
          relationTo: 'consumables',
          hasMany: true,
          label: 'Consommables équipés',
          admin: {
            description: 'Consommables portés sur le backpack. L\'espace total dépend du backpack équipé.',
          },
        },
        {
          ...
          type: 'relationship',
          relationTo: 'consumables',
          label: 'Consommable équipé 1 (obsolète)',
          admin: { hidden: true },
        },
        {
          ...
          type: 'relationship',
          relationTo: 'consumables',
          label: 'Consommable équipé 2 (obsolète)',
          admin: { hidden: true },
        },
        {
          ...
          type: 'relationship',
          relationTo: 'consumables',
          label: 'Consommable équipé 3 (obsolète)',
          admin: { hidden: true },
        },
      ],
    },
